...
describe('runtime cost runtime', () => {
  ...
  it('estimates configured cost from tokens', () => {
    expect(estimateRuntimeCostUsd({ model_source: 'supabase', model_prompt_slug: 'intent_analyzer', tokens_used: 1000 })).toBeGreaterThan(0)
