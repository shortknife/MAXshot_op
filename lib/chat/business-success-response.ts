import { buildBusinessNextActionsByMode, buildEvidenceChain } from '@/lib/chat/query-strategy'
  ...
  return {
    ...
    data: buildUserOutcome({
      ...
      meta: {
        ...
        highlights: buildBusinessHighlights(params.rows, params.scope || undefined),
        ...
        next_actions: params.nextActions || buildBusinessNextActionsByMode(params.resolvedScope, params.queryMode, true),
